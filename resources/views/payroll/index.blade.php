                        ...
                        @else 
                            ...
                            <div class="dropdown btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" style="overflow-x: hidden; max-height: 23em; height: auto;">
                                    ...
                                    @endfor
                                    <li><a href="#" onclick="printJS({printable:'{!! route('print_pdf_payroll', [$procedure->year, $procedure->month->id, 'report_type=P', 'report_name=B-2', 'valid_contracts=0', 'consultant=0', 'with_account=0', 'management_entity=0', 'position_group=0', 'employer_number=1']) !!}', type:'pdf', showModal:true, modalMessage: 'Generando documento por favor espere un momento.'})">B-2 (REPRESENTACIÓN CENTRAL)</a></li>
